...
#
{
    ...
    my $result = $api->document_export_download_export_result(task_id => $task_id);
}
...
#
{
    ...
    my $result = $api->document_export_request_export(document_ids => $document_ids, type => $type, stage_number => $stage_number);
}
