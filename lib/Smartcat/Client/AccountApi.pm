...
sub account_add_inhouse_translator {
    ...
    unless (exists $args{'model'}) {
      croak("Missing the required parameter 'model' when calling account_add_inhouse_translator");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('MyTeamMemberModel', $response);
...
sub account_get_account_info {
    ...
    my $_response_object = $self->{api_client}->deserialize('AccountModel', $response);
    return $_response_object;
}
...
sub account_get_lsp_services {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[LspServiceModel]', $response);
    return $_response_object;
}
...
sub account_get_mt_engines_for_account {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[MTEngineModel]', $response);
    return $_response_object;
}
...
# @param string $external_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'account_get_my_team_member_by_external_id' } = { 
    	summary => '',
        params => $params,
        returns => 'MyTeamMemberModel',
        };
...
sub account_get_my_team_member_by_external_id {
    ...
    unless (exists $args{'external_id'}) {
      croak("Missing the required parameter 'external_id' when calling account_get_my_team_member_by_external_id");
    }
...
sub account_get_my_team_member_by_id {
    ...
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling account_get_my_team_member_by_id");
    }
...
sub account_remove_user_from_my_team {
    ...
    # verify the required parameter 'user_id' is set
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling account_remove_user_from_my_team");
    }
...
sub account_search_my_team {
    ...
    unless (exists $args{'request_model'}) {
      croak("Missing the required parameter 'request_model' when calling account_search_my_team");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[MyTeamMemberModel]', $response);
    return $_response_object;
}
