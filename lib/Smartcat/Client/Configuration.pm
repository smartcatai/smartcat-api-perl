...
#
package Smartcat::Client::Configuration;
...
=head1 Name
        ...
        Smartcat::Client::Configuration - holds the configuration for all Smartcat::Client Modules
