...
sub translation_memories_create_empty_tm {
    ...
    unless (exists $args{'model'}) {
      croak("Missing the required parameter 'model' when calling translation_memories_create_empty_tm");
    }
...
sub translation_memories_export_file {
    ...
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_export_file");
    }

    # verify the required parameter 'export_mode' is set
    unless (exists $args{'export_mode'}) {
      croak("Missing the required parameter 'export_mode' when calling translation_memories_export_file");
    }

    # verify the required parameter 'with_tags' is set
    unless (exists $args{'with_tags'}) {
      croak("Missing the required parameter 'with_tags' when calling translation_memories_export_file");
    }
    ...
    if ( exists $args{'export_mode'}) {
        $query_params->{'exportMode'} = $self->{api_client}->to_query_value($args{'export_mode'});
    }

    # query params
    if ( exists $args{'with_tags'}) {
        $query_params->{'withTags'} = $self->{api_client}->to_query_value($args{'with_tags'});
    }
...
sub translation_memories_get_meta_info {
    ...
    # verify the required parameter 'tm_id' is set
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_get_meta_info");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TranslationMemoryModel', $response);
    return $_response_object;
}
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_get_pending_tasks' } = { 
...
sub translation_memories_get_pending_tasks {
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[TMImportTaskModel]', $response);
    return $_response_object;
}
...
# @param string $tm_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_get_tm_translations' } = { 
    	summary => '',
        params => $params,
...
sub translation_memories_get_tm_translations {
    ...
    unless (exists $args{'request'}) {
      croak("Missing the required parameter 'request' when calling translation_memories_get_tm_translations");
    }

    # verify the required parameter 'tm_id' is set
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_get_tm_translations");
    }
    ...
    # query params
    if ( exists $args{'tm_id'}) {
        $query_params->{'tmId'} = $self->{api_client}->to_query_value($args{'tm_id'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('SegmentWithMatchesModel', $response);
    return $_response_object;
}
...
# @param string $search_name  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_get_translation_memories_batch' } = { 
    	summary => '',
        params => $params,
...
sub translation_memories_get_translation_memories_batch {
    ...
    unless (exists $args{'last_processed_id'}) {
      croak("Missing the required parameter 'last_processed_id' when calling translation_memories_get_translation_memories_batch");
    }

    # verify the required parameter 'batch_size' is set
    unless (exists $args{'batch_size'}) {
      croak("Missing the required parameter 'batch_size' when calling translation_memories_get_translation_memories_batch");
    }
    ...
    if ( exists $args{'last_processed_id'}) {
        $query_params->{'lastProcessedId'} = $self->{api_client}->to_query_value($args{'last_processed_id'});
    }
    ...
    if ( exists $args{'search_name'}) {
        $query_params->{'searchName'} = $self->{api_client}->to_query_value($args{'search_name'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ARRAY[TranslationMemoryModel]', $response);
    return $_response_object;
}
...
sub translation_memories_import {
    ...
    # verify the required parameter 'tm_id' is set
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_import");
    }

    # verify the required parameter 'replace_all_content' is set
    unless (exists $args{'replace_all_content'}) {
      croak("Missing the required parameter 'replace_all_content' when calling translation_memories_import");
    }

    # verify the required parameter 'tmx_file' is set
    unless (exists $args{'tmx_file'}) {
      croak("Missing the required parameter 'tmx_file' when calling translation_memories_import");
    }
    ...
    if ( exists $args{'replace_all_content'}) {
        $query_params->{'replaceAllContent'} = $self->{api_client}->to_query_value($args{'replace_all_content'});
    }
...
# @param string $task_id ID of the task for import to the TM (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_remove_specific_import_task' } = { 
...
sub translation_memories_remove_specific_import_task {
    ...
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling translation_memories_remove_specific_import_task");
    }
...
# @param string $tm_id TM ID (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_remove_translation_memory' } = { 
...
sub translation_memories_remove_translation_memory {
    ...
    # verify the required parameter 'tm_id' is set
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_remove_translation_memory");
    }
...
# @param ARRAY[string] $target_languages Array of the required target languages (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'translation_memories_set_tm_target_languages' } = { 
...
sub translation_memories_set_tm_target_languages {
    ...
    # verify the required parameter 'tm_id' is set
    unless (exists $args{'tm_id'}) {
      croak("Missing the required parameter 'tm_id' when calling translation_memories_set_tm_target_languages");
    }

    # verify the required parameter 'target_languages' is set
    unless (exists $args{'target_languages'}) {
      croak("Missing the required parameter 'target_languages' when calling translation_memories_set_tm_target_languages");
    }
