...
sub document_assign_executives {
    ...
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_assign_executives");
    }

    # verify the required parameter 'stage_number' is set
    unless (exists $args{'stage_number'}) {
      croak("Missing the required parameter 'stage_number' when calling document_assign_executives");
    }

    # verify the required parameter 'request' is set
    unless (exists $args{'request'}) {
      croak("Missing the required parameter 'request' when calling document_assign_executives");
    }
    ...
    if ( exists $args{'document_id'}) {
        $query_params->{'documentId'} = $self->{api_client}->to_query_value($args{'document_id'});
    }
...
# @param ARRAY[string] $freelancer_user_ids Assignee IDs (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'document_assign_freelancers_to_document' } = { 
...
sub document_assign_freelancers_to_document {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_assign_freelancers_to_document");
    }

    # verify the required parameter 'stage_number' is set
    unless (exists $args{'stage_number'}) {
      croak("Missing the required parameter 'stage_number' when calling document_assign_freelancers_to_document");
    }

    # verify the required parameter 'freelancer_user_ids' is set
    unless (exists $args{'freelancer_user_ids'}) {
      croak("Missing the required parameter 'freelancer_user_ids' when calling document_assign_freelancers_to_document");
    }
...
sub document_assign_my_team_executives {
    ...
    unless (exists $args{'request_model'}) {
      croak("Missing the required parameter 'request_model' when calling document_assign_my_team_executives");
    }
...
sub document_delete {
    ...
    unless (exists $args{'document_ids'}) {
      croak("Missing the required parameter 'document_ids' when calling document_delete");
    }
...
sub document_get {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_get");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('DocumentModel', $response);
    return $_response_object;
}
...
sub document_get_auth_url {
    ...
    unless (exists $args{'user_id'}) {
      croak("Missing the required parameter 'user_id' when calling document_get_auth_url");
    }

    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_get_auth_url");
    }
...
sub document_get_statistics {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_get_statistics");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('DocumentStatisticsModel', $response);
    return $_response_object;
}
...
sub document_get_translation_status {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_get_translation_status");
    }
...
# @param string $document_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'document_get_translations_import_result' } = { 
    	summary => '',
        params => $params,
        returns => 'Object',
        };
...
sub document_get_translations_import_result {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_get_translations_import_result");
    }
...
sub document_rename {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_rename");
    }

    # verify the required parameter 'name' is set
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling document_rename");
    }
...
sub document_translate {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_translate");
    }

    # verify the required parameter 'translation_file' is set
    unless (exists $args{'translation_file'}) {
      croak("Missing the required parameter 'translation_file' when calling document_translate");
    }
    ...
    if ( exists $args{'overwrite'}) {
        $query_params->{'overwrite'} = $self->{api_client}->to_query_value($args{'overwrite'});
    }

    # query params
    if ( exists $args{'confirm_translation'}) {
        $query_params->{'confirmTranslation'} = $self->{api_client}->to_query_value($args{'confirm_translation'});
    }

    # form params
    if ( exists $args{'translation_file'} ) {
        $form_params->{'translationFile'} = [] unless defined $form_params->{'translationFile'};
...
sub document_translate_with_xliff {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_translate_with_xliff");
    }

    # verify the required parameter 'confirm_translation' is set
    unless (exists $args{'confirm_translation'}) {
      croak("Missing the required parameter 'confirm_translation' when calling document_translate_with_xliff");
    }

    # verify the required parameter 'overwrite_updated_segments' is set
    unless (exists $args{'overwrite_updated_segments'}) {
      croak("Missing the required parameter 'overwrite_updated_segments' when calling document_translate_with_xliff");
    }

    # verify the required parameter 'translation_file' is set
    unless (exists $args{'translation_file'}) {
      croak("Missing the required parameter 'translation_file' when calling document_translate_with_xliff");
    }
    ...
    if ( exists $args{'overwrite_updated_segments'}) {
        $query_params->{'overwriteUpdatedSegments'} = $self->{api_client}->to_query_value($args{'overwrite_updated_segments'});
    }
...
sub document_update {
    ...
    # verify the required parameter 'document_id' is set
    unless (exists $args{'document_id'}) {
      croak("Missing the required parameter 'document_id' when calling document_update");
    }

    # verify the required parameter 'update_document_model' is set
    unless (exists $args{'update_document_model'}) {
      croak("Missing the required parameter 'update_document_model' when calling document_update");
    }
