...
#
package Smartcat::Client::Object::SegmentWithMatchesModel;
...
__PACKAGE__->method_documentation({
    ...
    'segment_match' => {
    	datatype => 'int',
    	base_name => 'segmentMatch',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'tags' => {
    	datatype => 'ARRAY[TagsFromUnit]',
    	base_name => 'tags',
    	description => '',
    	format => '',
    	read_only => '',
