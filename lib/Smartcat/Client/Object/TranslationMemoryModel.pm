...
#
package Smartcat::Client::Object::TranslationMemoryModel;
...
__PACKAGE__->method_documentation({
    ...
    'is_automatically_created' => {
    	datatype => 'boolean',
    	base_name => 'isAutomaticallyCreated',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'unit_count_by_language_id' => {
    	datatype => 'HASH[string,int]',
    	base_name => 'unitCountByLanguageId',
    	description => '',
    	format => '',
    	read_only => '',
    		},
...
__PACKAGE__->swagger_types( {
    ...
    'unit_count_by_language_id' => 'HASH[string,int]'
} );
...
__PACKAGE__->attribute_map( {
    ...
    'unit_count_by_language_id' => 'unitCountByLanguageId'
} );
