...
#
package Smartcat::Client::Object::ExecutiveStatisticsModel;
...
__PACKAGE__->method_documentation({
    ...
    'documents' => {
    	datatype => 'ARRAY[DocumentStatisticsModel]',
    	base_name => 'documents',
    	description => '',
    	format => '',
    	read_only => '',
...
__PACKAGE__->swagger_types( {
    ...
    'total' => 'ARRAY[StatisticsRowModel]',
    'documents' => 'ARRAY[DocumentStatisticsModel]'
} );
