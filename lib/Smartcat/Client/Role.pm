...
This module is generated by Swagger Codegen https://github.com/swagger-api/swagger-codegen. It is used and tested for C<Smartcat::App> only.
...
has api_factory => (
    is            => 'ro',
    isa           => 'Smartcat::Client::ApiFactory',
    builder       => '_build_af',
    lazy          => 1,
...
has _cfg => (
    is      => 'ro',
    isa     => 'Smartcat::Client::Configuration',
    default => sub { Smartcat::Client::Configuration->new() },
);
...
has version_info => (
    ...
    default => sub {
        {
            app_name        => 'Smartcat Integration API',
            app_version     => 'v1',
...
sub _build_af {
    ...
    return Smartcat::Client::ApiFactory->new(%args);
}
...
=head2 Smartcat Integration API version: v1
...
The tokens will be placed in a C<Smartcat::Client::Configuration> instance
