...
# @param string $name client&#39;s name (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'client_create_client' } = { 
    	summary => 'Create a new client with the specified name and return their ID.              Simply return the ID if a client with that name already exists',
        params => $params,
        returns => 'string',
        };
}
...
sub client_create_client {
    ...
    unless (exists $args{'name'}) {
      croak("Missing the required parameter 'name' when calling client_create_client");
    }
...
sub client_get_client {
    ...
    unless (exists $args{'client_id'}) {
      croak("Missing the required parameter 'client_id' when calling client_get_client");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('ClientModel', $response);
    return $_response_object;
}
...
sub client_set_client_net_rate {
    ...
    # verify the required parameter 'client_id' is set
    unless (exists $args{'client_id'}) {
      croak("Missing the required parameter 'client_id' when calling client_set_client_net_rate");
    }

    # verify the required parameter 'net_rate_id' is set
    unless (exists $args{'net_rate_id'}) {
      croak("Missing the required parameter 'net_rate_id' when calling client_set_client_net_rate");
    }
    ...
    if ( exists $args{'net_rate_id'}) {
        $query_params->{'netRateId'} = $self->{api_client}->to_query_value($args{'net_rate_id'});
    }
